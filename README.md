...
---------|-------------
 ...
 [**func_ptr.hpp**](https://github.com/iboB/itlib/blob/master/include/itlib/func_ptr.hpp) [![Standard](https://img.shields.io/badge/C%2B%2B-11-blue.svg)](https://en.cppreference.com/w/cpp/11.html) | A non-owning type-erased function pointer. Similar to `std::function_ref` from C++26, but nullable.
